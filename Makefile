# Makefile for MINI compiler (v1.7). (Jingke Li)
#
JFLAGS = -g
JC = javac
JCC = javacc
...
ast: 	ast/ArrayElm.class ast/ArrayLen.class ast/ArrayType.class              \
	...
	ast/ExpList.class ast/Field.class ast/Formal.class                     \
...
ir: 	ir/BINOP.class ir/CALL.class ir/CALLST.class ir/CJUMP.class 	    \
	...
	ir/FIELD.class ir/FUNC.class ir/FUNClist.class                      \
...
interp: ir interp/Val.class interp/Intval.class  \
	interp/Interp.class interp/TestInterp.class

codegen: ir irpsr codegen/Operand.class codegen/Reg.class codegen/RegOffset.class \
	codegen/Immed.class codegen/Label.class \
